...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.PermissionTO")]

public class Permission implements IClonable    {
	...
	public static var notOverwritePermission:int;
    ...
    {
        return ( ( this.task == task ) && ( this.right == right ) );
    }
}
