...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.ModelChainTO")]

public class ModelChain implements IClonable
{
	...
	public static var notOverwriteModelChain:int;
	
    public var temporalScale:TemporalScale;
    ...
    {
        var clone:ModelChain = new ModelChain();
        clone.id = this.id;
        clone.label = this.label;
        clone.description = this.description;
        clone.temporalScale = this.temporalScale;
        clone.spatialScale = this.spatialScale;
        return clone;
    }
}
