...
package org.seamless_ip.services.transferobjects.seamproj
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.PermisionGroupTO")]

	public class PermisionGroup implements IClonable	{
		public function PermisionGroup()
		{
		...
		{
			var clone: PermisionGroup = new PermisionGroup();
			var item:IClonable;  
			clone.id = this.id;
