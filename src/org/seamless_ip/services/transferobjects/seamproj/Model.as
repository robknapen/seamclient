...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.ModelTO")]

public class Model implements IClonable    {
	...
	public static var notOverwriteModel:int;
	
    public function Model()
    {
        spatialScales = new ArrayCollection();
    }


    public var spatialScales: ArrayCollection;
    ...
    {
        var clone: Model = new Model();
        var item:IClonable;
        for each (item in this.spatialScales)
            clone.spatialScales.addItem(item.Clone());
        clone.spatialScales = this.spatialScales;
