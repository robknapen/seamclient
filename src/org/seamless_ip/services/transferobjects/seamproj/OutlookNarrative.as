...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.OutlookNarrativeTO")]

public class OutlookNarrative implements IClonable {
	...
	public static var notOverwriteOutlookNarrative:int;
	
    public function OutlookNarrative()
    {
        selected = false;
    }
    ...
    {
        var clone: OutlookNarrative = new OutlookNarrative();
        var item:IClonable;
