/*
 * wallace: PolicyOptionNarrative.as
 * ==============================================================================
...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.PolicyOptionNarrativeTO")]

public class PolicyOptionNarrative implements IClonable {
	...
	public static var notOverwritePolicyOptionNarrative:int;
	
    public function PolicyOptionNarrative()
    {
        selected = false;
    }
    ...
    {
        var clone: PolicyOptionNarrative = new PolicyOptionNarrative();
        var item:IClonable;
