...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.ProjectRoleTO")]

public class ProjectRole implements IClonable, IRole    {
    ...
    {
        var clone: ProjectRole = new ProjectRole();
        var item:IClonable;
    ...
    public function setPermissions(value:ArrayCollection):void {
        permissions = value;
    }
