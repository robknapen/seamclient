/*
 * wallace: BiophysicalSimulationNarrative.as
 * ==============================================================================
...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.BiophysicalSimulationNarrativeTO")]

public class BiophysicalSimulationNarrative implements IClonable
{
	...
	public static var notOverwriteBiophysicalSimulationNarrative:int;
	
    public function BiophysicalSimulationNarrative()
    {
    }


    public var outlook: OutlookNarrative;
    public var context: ContextNarrative;
    public var id: String;

    public function Clone():IClonable
    {
        var clone: BiophysicalSimulationNarrative = new BiophysicalSimulationNarrative();
        var item:IClonable;
        clone.outlook = (OutlookNarrative)(this.outlook.Clone());
        clone.context = (ContextNarrative)(this.context.Clone());
        return clone;
    }
}
}
