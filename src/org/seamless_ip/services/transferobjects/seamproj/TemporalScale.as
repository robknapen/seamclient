...
{
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.seamproj.TemporalScaleTO")]

public class TemporalScale
{
	...
	public static var notOverwriteTemporalScale:int;
	
    public var id:String;
    public var rank:int = 0;
    public var extent:String = "Undefined";
    public var resolution:String = "Undefined";

    public function get label():String
    {
        if ((extent == "Undefined") && (resolution == "Undefined"))
            return "Undefined";
        else
