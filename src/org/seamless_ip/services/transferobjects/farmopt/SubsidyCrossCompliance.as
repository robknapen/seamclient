/*
 * wallace: SubsidyCrossCompliance.as
 * ==============================================================================
...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.farmopt.SubsidyCrossComplianceTO")]

public class SubsidyCrossCompliance implements IClonable, IPolicyMeasure    {
    ...
    public function SubsidyCrossCompliance()
    {
    }
    ...
    {
        var clone: SubsidyCrossCompliance = new SubsidyCrossCompliance();
        var item:IClonable;
