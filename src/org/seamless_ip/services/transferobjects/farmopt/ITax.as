...
package org.seamless_ip.services.transferobjects.farmopt
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.farmopt.ITaxTO")]

	public interface ITax extends IClonable, IPolicyMeasure	{
	
			
		
		function set tax(value: Number):void
		function get tax(): Number;
