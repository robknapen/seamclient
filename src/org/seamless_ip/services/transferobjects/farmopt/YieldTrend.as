...
package org.seamless_ip.services.transferobjects.farmopt
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.farmopt.YieldTrendTO")]

	public class YieldTrend implements IClonable, IBaseLineValue	{
		public function YieldTrend()
		{
		}	
		...
		{
			var clone: YieldTrend = new YieldTrend();
			var item:IClonable;  
