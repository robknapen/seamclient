...
package org.seamless_ip.services.transferobjects.farmopt
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.farmopt.IPenaltyTO")]

	public interface IPenalty extends IClonable, IPolicyMeasure	{
	
			
		
		function set penalty(value: Number):void
		function get penalty(): Number;
