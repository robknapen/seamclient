...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.YieldGrowthTO")]

	public class YieldGrowth implements IClonable, IBaseLineValue, ICAPRIParameter	{
		public function YieldGrowth()
		{
		}	
		...
		{
			var clone: YieldGrowth = new YieldGrowth();
			var item:IClonable;  
			clone.activityGroup = (ActivityGroup)(this.activityGroup .Clone());
