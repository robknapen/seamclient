...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.CountryAggregateTO")]

	public class CountryAggregate implements IClonable, IRegion	{
		public function CountryAggregate()
		{
		}	
		...
		{
			var clone: CountryAggregate = new CountryAggregate();
			var item:IClonable;  
			clone.id = this.id;
