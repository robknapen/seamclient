...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.DemandShiftTO")]

	public class DemandShift implements IClonable, IBaseLineValue, ICAPRIParameter	{
		public function DemandShift()
		{
		}	
		...
		{
			var clone: DemandShift = new DemandShift();
			var item:IClonable;  
