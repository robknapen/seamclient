...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.BiofuelDemandTO")]

	public class BiofuelDemand implements IClonable, IBaseLineValue, ICAPRIParameter	{
		public function BiofuelDemand()
		{
		}	
		...
		{
			var clone: BiofuelDemand = new BiofuelDemand();
			var item:IClonable;  
