...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.SubsidisedExportTO")]

	public class SubsidisedExport implements IClonable, IBaseLineValue, ICAPRIParameter	{
		public function SubsidisedExport()
		{
		}	
		...
		{
			var clone: SubsidisedExport = new SubsidisedExport();
			var item:IClonable;  
