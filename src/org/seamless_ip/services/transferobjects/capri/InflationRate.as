...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.InflationRateTO")]

	public class InflationRate implements IClonable, IBaseLineValue, ICAPRIParameter	{
		public function InflationRate()
		{
		}	
		...
		{
			var clone: InflationRate = new InflationRate();
			var item:IClonable;  
