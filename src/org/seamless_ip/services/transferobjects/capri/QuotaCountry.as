...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.QuotaCountryTO")]

	public class QuotaCountry implements IClonable, ICAPRIParameter	{
		public function QuotaCountry()
		{
		}	
		...
		{
			var clone: QuotaCountry = new QuotaCountry();
			var item:IClonable;  
			...
			clone.quotaShare = this.quotaShare;
			return clone;
		}
	}
