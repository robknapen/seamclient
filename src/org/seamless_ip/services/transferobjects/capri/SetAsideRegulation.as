...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.SetAsideRegulationTO")]

	public class SetAsideRegulation implements IClonable, ICAPRIParameter	{
		public function SetAsideRegulation()
		{
		}	
			
		
		public var baselineValueMax: Number;
		public var baselineValueMin: Number;
		...
		{
			var clone: SetAsideRegulation = new SetAsideRegulation();
			var item:IClonable;  
			clone.baselineValueMax = this.baselineValueMax;
			clone.baselineValueMin = this.baselineValueMin;
