/* wallace: SupplyShift.as
 * ==============================================================================
 * This class was manually added, based on the DemandShift class, as a short term
...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.SupplyShiftTO")]

	/**
	 * Value object for Supply Shift.
	 * 
	 * This class was coded by hand and should later be replaced by a class made
	 * by the code generators.
	 */
	public class SupplyShift implements IClonable, IBaseLineValue, ICAPRIParameter	{
		...
		public function Clone():IClonable {
			var clone: SupplyShift = new SupplyShift();
			var item:IClonable;
