...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.ModulationTO")]

	public class Modulation implements IClonable, IBaseLineValue, ICAPRIParameter	{
		...
		{
			var clone: Modulation = new Modulation();
			var item:IClonable;  
