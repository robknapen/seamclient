...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.PremiumGroupTO")]

	public class PremiumGroup implements IClonable	{
		public function PremiumGroup()
		{
		}	
		...
		{
			var clone: PremiumGroup = new PremiumGroup();
			var item:IClonable;  
			clone.id = this.id;
