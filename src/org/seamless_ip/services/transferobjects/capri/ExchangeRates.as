...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.ExchangeRatesTO")]

	public class ExchangeRates implements IClonable, IBaseLineValue, ICAPRIParameter	{
		...
		{
			var clone: ExchangeRates = new ExchangeRates();
			var item:IClonable;  
