...
package org.seamless_ip.services.transferobjects.capri
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.capri.BasicPremiumTO")]

	public class BasicPremium implements IClonable, ICAPRIParameter	{
		public function BasicPremium()
		{
		}	
			
		
		public var applicationType: String;
		public var baseyearPriceChange: Number;
		...
		{
			var clone: BasicPremium = new BasicPremium();
			var item:IClonable;  
			clone.applicationType = this.applicationType;
			clone.baseyearPriceChange = this.baseyearPriceChange;
			clone.id = this.id;
