...
package org.seamless_ip.services.transferobjects.farm
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.farm.FADNregionTO")]

	public class FADNregion implements IClonable, IRegion	{
		public function FADNregion()
		{
		}	
		...
		{
			var clone: FADNregion = new FADNregion();
			var item:IClonable;  
			clone.id = this.id;
