...
package org.seamless_ip.services.transferobjects.indi
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.indi.DimensionTO")]

	public class Dimension implements IClonable	{
		...
		{
			var clone: Dimension = new Dimension();
			var item:IClonable;  
			clone.id = this.id;
