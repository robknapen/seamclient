...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.indi.ModelVariableTO")]

public class ModelVariable implements IIndicator
{
    ...
    public function setTemporalScale(value:TemporalScale):void {
        if (value != null)
            ...
            temporalScale = new TemporalScale();
    }
