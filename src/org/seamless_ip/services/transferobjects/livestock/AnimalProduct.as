...
package org.seamless_ip.services.transferobjects.livestock
{
	...
	[Bindable]
	[RemoteClass(alias="org.seamless_ip.services.transferobjects.livestock.AnimalProductTO")]

	public class AnimalProduct implements IClonable, IProduct	{
		public function AnimalProduct()
		{
		}	
		...
		{
			var clone: AnimalProduct = new AnimalProduct();
			var item:IClonable;  
			clone.id = this.id;
