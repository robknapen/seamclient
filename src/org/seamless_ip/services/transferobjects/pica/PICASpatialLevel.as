...
[Bindable]
[RemoteClass(alias="org.seamless_ip.services.transferobjects.pica.PICASpatialLevelTO")]


public class PICASpatialLevel implements IClonable {
	...
	public static var notOverwritePICASpatialLevel:int;
	

    public function PICASpatialLevel() {
    }

    public var selected:Boolean;
    public var fromInstitutionalCompability:InstitutionalCompatibility;
    ...
    public function Clone():IClonable {
        var clone:PICASpatialLevel = new PICASpatialLevel();
        var item:IClonable;
        clone.selected = this.selected;
        clone.fromInstitutionalCompability = (InstitutionalCompatibility)(this.fromInstitutionalCompability.Clone());
