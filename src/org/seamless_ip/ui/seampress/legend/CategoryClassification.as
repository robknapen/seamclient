/*
 * wallace: CategoryClassification.as
 * ==============================================================================
...
{
/**
 * Map classification based on categories.
 *
...
{
    public static const PARAMNAME: String = "Category";
    ...
    override public function findItemForValue(value: Object):LegendElement
    {
        for each (var obj: Object in this)
            if ((obj is CategoryLegendElement) && (CategoryLegendElement(obj).caption == value))
                return obj as CategoryLegendElement;
    ...
    {
        var element: CategoryLegendElement = new CategoryLegendElement();
        addItem(element);
        return element;
    }
